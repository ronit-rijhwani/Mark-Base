...
class TestAttendanceTiming(unittest.TestCase):
    ...
    def test_before_window(self):
        with self.assertRaises(HTTPException) as context:
            determine_status("14:59:59")
        self.assertEqual(context.exception.status_code, 400)
    
    def test_present_window(self):
        # Edge cases and mid window
        self.assertEqual(determine_status("15:00:00"), "present")
        self.assertEqual(determine_status("15:05:00"), "present")
        self.assertEqual(determine_status("15:10:59"), "present")
        
    def test_late_window(self):
        # Edge cases and mid window
        self.assertEqual(determine_status("15:11:00"), "late")
        self.assertEqual(determine_status("15:13:00"), "late")
        self.assertEqual(determine_status("15:15:59"), "late")
        
    def test_absent_window(self):
        # After cutoff
        self.assertEqual(determine_status("15:16:00"), "absent")
